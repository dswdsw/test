...
- (void)layOut {
    ...
    _btnOK = [UIButton buttonWithType:UIButtonTypeCustom];
        ...
        if (IOS7LATER) {
            ...
            _btnOK.frame = CGRectMake(self.view.frame.size.width - 80, _scrollerview.frame.size.height + 9, 61, 32);
        }
#endif
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {} else {
        ...
        _btnOK.frame = CGRectMake(self.view.frame.size.width - 80, _scrollerview.frame.size.height + 11, 61, 32);
    }
